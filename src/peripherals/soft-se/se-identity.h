 ...
 */
#define LORAWAN_DEVICE_EUI                                 { 0x00, 0x89, 0xDC, 0x80, 0x0B, 0x11, 0xF5, 0xC8 }
// #define LORAWAN_DEVICE_EUI                                 { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }

/*!
 * App/Join server IEEE EUI (big endian)
 */
#define LORAWAN_JOIN_EUI                                   { 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x03, 0xA4, 0x8D }
...
#define SOFT_SE_KEY_LIST                                                                                            \
    {                                                                                                               \
        {                                                                                                           \
             ...
             */                                                                                                     \
            .KeyID    = APP_KEY,                                                                                    \
            .KeyValue = { 0xBD, 0x17, 0x8B, 0x31, 0x27, 0x04, 0xAC, 0x1C, 0x43, 0x2C, 0xE4, 0xBF, 0xBE, 0x26, 0xBA, \
                            0x41 },                                                                                 \
        },                                                                                                          \
        {                                                                                                           \
            /*!                                                                                                     \
